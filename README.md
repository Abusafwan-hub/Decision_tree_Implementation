Decision Tree Implementation This repository contains a machine learning implementation of a Decision Tree classifier using scikit-learn, applied to a personality prediction dataset.
